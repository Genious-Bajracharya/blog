export default function Blog1() {
  return (
    <div className="flex px-4 gap-4 justify-around flex-wrap">
      <div className="max-w-sm w-1/5 bg-white   rounded-lg ">
        <a href="/blogpost">
          <img
      ...
      <div className="max-w-sm w-1/5 bg-white   rounded-lg ">
        <a href="/blogpost">
          <img
            className="rounded-t-lg"
            src="https://images.pexels.com/photos/2002719/pexels-photo-2002719.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt=""
          />
        </a>
        <div className="p-5">
